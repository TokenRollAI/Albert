...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cache::delete_request_cache,
            commands::cache::delete_stale_request_cache,
            commands::cache::find_request_cache,
            commands::cache::list_request_cache,
            commands::cache::save_request_cache,
            ...
            commands::parser::validate_mock_payload,
            ...
            commands::openai::delete_provider_config,
            commands::openai::generate_mock_example,
            commands::openai::list_provider_configs,
            commands::openai::provider_env_status,
            commands::openai::preview_generation_prompt,
            commands::openai::save_provider_config,
