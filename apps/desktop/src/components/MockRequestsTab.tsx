...
import { Sparkline, type SparkBucket } from "./Sparkline";
...
// Re-export so tests and external callers don't have to import the
// component file directly; keeps MockRequestsTab the single source of
// truth for "everything log-related".
